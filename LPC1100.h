...
#define __enable_irqn(n) ISER0 = 1 << (n)
#define __disable_irqn(n) ICER0 = 1 << (n)
#define __test_irqn_enabled(n) (ICER0 & (1 << (n)))
#define __set_irqn(n) ISPR0 = 1 << (n)
#define __clear_irqn(n) ICPR0 = 1 << (n)
#define __test_irqn(n) (ICPR0 & (1 << n))
#define __test_irqn_active(n) (IABR0 & (1 << (n)))
#define __set_irqn_priority(n,v) IPR[n/4] = (IPR[n/4] & ~(0xFF<<((n%4)*8))) | ((v)<<((n%4)*8))
#define __set_faultn_priority(n,v) SHPR[(n+16)/4] = (SHPR[(n+16)/4] & ~(0xFF<<(((n+16)%4)*8))) | ((v)<<(((n+16)%4)*8))
...
/* LPC11xx Power Control */
#define	__enable_ahbclk(v)	SYSAHBCLKCTRL |= (v)
#define	__disable_ahbclk(v)	SYSAHBCLKCTRL &= ~(v)
#define	PCROM		0x00002
#define	PCRAM		0x00004
#define	PCFLASHREG	0x00008
#define	PCFLASHARRAY	0x00010
#define	PCI2C		0x00020
#define	PCGPIO		0x00040
#define	PCCT16B0	0x00080
#define	PCCT16B1	0x00100
#define	PCCT32B0	0x00200
#define	PCCT32B1	0x00400
#define	PCSSP0		0x00800
#define	PCUART		0x01000
#define	PCADC		0x02000
#define	PCWDT		0x08000
#define	PCIOCON		0x10000
