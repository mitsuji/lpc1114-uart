...
void test_allocstr()
{
  ...
  allocstr_init(head,sizeof(head));
  ...
  test_allocstr_free(strs,(sizeof(strs)/sizeof(uint16_t)), strs[3]);
  test_allocstr_print(strs, (sizeof(strs)/sizeof(uint16_t)));
  ...
  test_allocstr_free(strs,(sizeof(strs)/sizeof(uint16_t)), strs[1]);
  test_allocstr_free(strs,(sizeof(strs)/sizeof(uint16_t)), strs[2]);
  test_allocstr_free(strs,(sizeof(strs)/sizeof(uint16_t)), strs[3]);
  test_allocstr_print(strs, (sizeof(strs)/sizeof(uint16_t)));

  test_allocstr_free(strs,(sizeof(strs)/sizeof(uint16_t)), strs[0]);
  test_allocstr_free(strs,(sizeof(strs)/sizeof(uint16_t)), strs[4]);
  test_allocstr_print(strs, (sizeof(strs)/sizeof(uint16_t)));
  
  allocstr_alloc(&strs[1], "B");
  test_allocstr_print(strs, (sizeof(strs)/sizeof(uint16_t)));
  
  allocstr_alloc(&strs[0], "A");
  allocstr_alloc(&strs[2], "C");
  allocstr_alloc(&strs[3], "D");
  allocstr_alloc(&strs[4], "E");
  test_allocstr_print(strs, (sizeof(strs)/sizeof(uint16_t)));
